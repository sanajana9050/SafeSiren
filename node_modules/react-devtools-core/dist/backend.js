...
__webpack_require__.d(__webpack_exports__, "j", function() { return /* binding */ isSynchronousXHRSupported; });
...
exports.version = "18.3.0-experimental-77d3b02e5-20230417";
...
var agent_Agent = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Agent(bridge) {
    ...
    bridge.send('isSynchronousXHRSupported', Object(utils["j" /* isSynchronousXHRSupported */])());
...
function attach(hook, rendererID, renderer, global) {
  ...
  function getSerializedElementValueByPath(id, path) {
    ...
    if (inspectedElement !== null) {
      ...
      return Object(utils["k" /* serializeToString */])(valueToCopy);
    }
  }
